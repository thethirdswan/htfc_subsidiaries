...
public class HTFCSRecipeProvider extends RecipeProvider {
    ...
    protected void buildCraftingRecipes(Consumer<FinishedRecipe> consumer) {
        ShapedRecipeBuilder.shaped(HTFCSItems.TEMPERATURE_REGULATOR_UPGRADE.get())
                .pattern("cpc")
                .pattern("vav")
                .pattern("cpc")
                ...
                .unlockedBy("upgrades", InventoryChangeTrigger.TriggerInstance.hasItems(net.minecraft.world.item.Items.LAPIS_LAZULI))
                .save(consumer);
    ...
    protected void subsidiariesRecipes(Consumer<FinishedRecipe> consumer) {
        Recipe<CraftingContainer> wool_yarn_recipe = new ShapelessRecipe(new ResourceLocation("tfc", "wool_yarn"), "htfc_subsidiaries", new ItemStack(TFCItems.WOOL_YARN.get(), 8), NonNullList.of(Ingredient.of(HTFCSItemTags.SPINDLES), Ingredient.of(TFCItems.WOOL.get())));
        Recipe<CraftingContainer> pineapple_yarn_recipe = new ShapelessRecipe(new ResourceLocation("firmalife", "pineapple_yarn"), "htfc_subsidiaries", new ItemStack(FLItems.PINEAPPLE_YARN.get(), 8), NonNullList.of(Ingredient.of(HTFCSItemTags.SPINDLES), Ingredient.of(FLItems.PINEAPPLE_FIBER.get())));
...
//                .build(consumer, new ResourceLocation("htfc_subsidiaries:arc_furnace/hepatizon"));
    ...
    protected void buildIndustrialCheeseRecipes(Consumer<FinishedRecipe> consumer) {
        ...
        RefineryRecipeBuilder.builder(new FluidStack(ForgeRegistries.FLUIDS.getValue(new ResourceLocation("firmalife:cream")).defaultFluidState().getType(), 100))
                ...
                .setEnergy(100)
                .build(consumer, new ResourceLocation("htfc_subsidiaries", "refinery/cream"));
    }
}