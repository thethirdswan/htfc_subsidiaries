...
public class HTFCSItemModels extends ItemModelProvider {
	public HTFCSItemModels(DataGenerator generator, ExistingFileHelper existingFileHelper) {
	...
	protected void registerModels() {
        ...
        pncUpgradesModel(HTFCSItems.TEMPERATURE_REGULATOR_UPGRADE.get());
