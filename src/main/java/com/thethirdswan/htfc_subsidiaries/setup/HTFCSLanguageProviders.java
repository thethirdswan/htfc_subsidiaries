...
public class HTFCSLanguageProviders extends LanguageProvider {
	public HTFCSLanguageProviders(DataGenerator gen, String locale) {
	...
	protected void addTranslations() {
		...
		add(HTFCSItems.TEMPERATURE_REGULATOR_UPGRADE.get(), "Temperature Regulator Upgrade");
		// pneumatic GUI stuff
